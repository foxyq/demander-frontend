...
(function (c) {
  function m(a, c, d) {
    ...
    void 0 === a && (a = {});if ("object" !== (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a))) throw Error("(Format) 'format' option must be an object.");var h = {};c(u).each(function (c, n) {
      if (void 0 === a[n]) h[n] = A[c];else if ((0, _typeof3.default)(a[n]) === (0, _typeof3.default)(A[c])) {
        if ("decimals" === n && (0 > a[n] || 7 < a[n])) throw Error("(Format) 'format.decimals' option must be between 0 and 7.");h[n] = a[n];
      } else throw Error("(Format) 'format." + n + "' must be a " + (0, _typeof3.default)(A[c]) + ".");
    });m(h, "mark", "thousand");m(h, "prefix", "negative");m(h, "prefix", "negativeBefore");this.r = h;
  }function k(a, h) {
    "object" !== (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a)) && c.error("(Link) Initialize with an object.");return new k.prototype.p(a.target || function () {}, a.method, a.format || {}, h);
...
(function (c) {
  function m(e) {
    ...
    if ("object" !== (typeof b === "undefined" ? "undefined" : (0, _typeof3.default)(b)) || c.isArray(b)) throw Error("noUiSlider: 'range' is not an object.");if (void 0 === b.min || void 0 === b.max) throw Error("noUiSlider: Missing 'min' or 'max' in 'range'.");
  ...
  function O(a, b) {
    ...
    function g() {
      ...
      var a = Array.prototype.slice.call(arguments, 0),
          ...
          m,
          s,
          t = r(a[0]);"object" === (0, _typeof3.default)(a[1]) ? (d = a[1].set, e = a[1].link, g = a[1].update, h = a[1].animate) : !0 === a[1] && (d = !0);b.dir && 1 < b.b && t.reverse();h && k(q, f[14]);a = 1 < l.length ? 3 : 1;1 === t.length && (a = 1);for (m = 0; m < a; m++) {
